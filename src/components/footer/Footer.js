  ...
  return (
    ...
    >
      <SimpleGrid columns={[1, 2, 3, 4]} spacing={{base:12,md:16,lg:20}}>
        ...
        <Stack alignItems={{base:'center',md:'start'}} direction={'column'} spacing={3} lineHeight={1}>
        ...
        <Stack alignItems={'center'} direction={'column'}>
          ...
          <HStack alignItems={'baseline'}>
            ...
            <Text color={'#fff'} fontSize={'14px'} fontWeight={'400'}>
            20-KM, Baghdadi Street,<br/>Off Multan Road,Lahore,
              <br /> Punjab Pakistan
            </Text>
          </HStack>
        </Stack>
        <Stack alignItems={'center'} direction={'column'}>
          ...
          <HStack mt={1} gap={4}>
            <Link target="_blank" href="https://www.instagram.com/eveonpak/?igsh=dW55Y2FvcHBzNTdk">
              <FaInstagram color="#fff" size={20} />
            </Link>
            <Link target="_blank" href="https://www.facebook.com/eveonpakistan?mibextid=LQQJ4d">
